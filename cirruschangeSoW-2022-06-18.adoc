...
*Project Deliverables*
 ...
 . Putting in place domain verified SSL certificates for dev, test, and prod server instances in AWS EC2
 . Configuring inbound and outbound port rules as needed on the three servers
